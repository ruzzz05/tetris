...
/**
 * Esta clase pertenece a los Block*, es decir, a los subtipos de Block. Este en concreto es el BlockZ, que tiene forma de Z.
...
public class BlockZ extends Block {
    ...
    public BlockZ() {
        ...
        this.block.set(1, 2, 1);
        this.block.set(0, 2, 0);
        this.block.set(1, 0, 0);
        this.position = new Position();
        this.piece = new Piece(Color.GREEN, "Z", 4);
